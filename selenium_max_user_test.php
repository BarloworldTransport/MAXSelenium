...
/**
 * selenium_max_user_test.php
 *
 * @package selenium_max_user_test
 ...
 */
class selenium_max_user_test extends PHPUnit_Framework_TestCase {
	// : Constants
	...
	// : Magic
	/**
	 * selenium_max_user_test::__construct()
	 * Class constructor
	 */
	...
	/**
	 * selenium_max_user_test::__destruct()
	 * Class destructor
	...
	/**
	 * selenium_max_user_test::testFunctionTemplate
	...
	/**
	 * selenium_max_user_test::takeScreenshot($_session)
	 * This is a function description for a selenium test function
	 *
	...
	/**
	 * selenium_max_user_test::assertElementPresent($_using, $_value)
	 * This is a function description for a selenium test function
	 *
	 * @param string: $_using        	
	 * @param string: $_value        	
