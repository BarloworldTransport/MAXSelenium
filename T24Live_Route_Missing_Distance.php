...
/**
 * Object::T24Live_Route_Missing_Distance
 *
 ...
 */
class T24Live_Route_Missing_Distance extends PHPUnit_Framework_TestCase
{
    // : Constants
    ...
    const XLS_CREATOR = "T24Live_Route_Missing_Distance.php";
    ...
    // : Magic
    /**
     * T24Live_Route_Missing_Distance::__construct()
     * Class constructor
     */
    ...
    /**
     * T24Live_Route_Missing_Distance::__destruct()
     * Class destructor
    ...
    /**
     * T24Live_Route_Missing_Distance::testFunctionTemplate
    ...
    public function testFunctionTemplate()
    {
        ...
        if (file_exists($_xlsfile)) {
            ...
            try {
                ...
                // Setup variables
                $_duration = (int) 0;
                // Get total amount of records to process
                ...
                if ($_total != 0) {
                    for ($x = 1; $x <= $_total; $x ++) {
                        ...
                        try {
                            // Prepare SQL Query to get route data
                            $_sqlquery = preg_replace("/%s/", $_data["ID"][$x], $this->_myqueries[0]);
                            // Get SQL Query result
                            $_result = $this->queryDB($_sqlquery);
                            // If there is a result then process
                            if (count($_result) != 0) {
                                $_distance = $_result[0]["expectedKms"];
                                if (($_distance == "0.00") || ($_distance == NULL)) {
                                    $_distance = strval(round(floatval($_data["leadKms"][$x])));
    ...
    /**
     * T24Live_Route_Missing_Distance::writeExcelFile($excelFile, $excelData)
    ...
    /**
     * T24Live_Route_Missing_Distance::takeScreenshot()
     * This is a function description for a selenium test function
     *
    ...
    /**
     * T24Live_Route_Missing_Distance::assertElementPresent($_using, $_value)
     * This is a function description for a selenium test function
     *
     * @param string: $_using            
     * @param string: $_value            
    ...
    /**
     * T24Live_Route_Missing_Distance::openDB($dsn, $username, $password, $options)
    ...
    /**
     * T24Live_Route_Missing_Distance::closeDB()
    ...
    /**
     * T24Live_Route_Missing_Distance::queryDB($sqlquery)
