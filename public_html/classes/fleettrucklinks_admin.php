...
/*
 * IDEAS TO IMPLEMENT LATER (EXCLUSIVE TO FLEET TRUCK LINKS ADMIN): 1. Filters for trucks and fleets to make administrating quicker 2. Change selecting 1 truck to multiple trucks at a time for a batch process 3. Explore a busy processing foreground message while processing transactions 4. When multiple transactions are to be performed run a mysql transaction 5. RND better security for ajax calls CHANGES TO BE MADE: 1. Update js for selecting fleets to which multiple trucks belong too instead of (current code) single truck 2. Commit transaction once ready - validate all data and that there is a task to be performed 3. Complete add truck link code to add truck to DB and table on page to reflect current actions added by user
 */
...
<link rel="stylesheet" type="text/css"
	href="../assets/js/dtp/jquery.datetimepicker.css" />
...
<body>
		...
		<div class="row">
			...
			<div class="col-sm-3 col-md-2 sidebar">
				<ul class="nav nav-sidebar">
					<li class="active"><a href="?content=dashboard">My Dashboard <span
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<form name="truckLinkForm" id="frmMain" class="form-signin"
					role="form" action="addTruckLink.php" method="post">
					...
					<div class="row">
						...
						<div class="col-md-10">
							<select id="cbxOperation" name="opSelect" class="form-control"
								onchange="" required>
					...
					<div class="row">
						...
						<!-- End -->
							...
							<div class="row">
								<div class="col-md-2">
									<button class="btn btn-default" name="btnAddTruckToList"
										type="button" onclick="addTruckToPanel()">Add Truck to
										Operation</button>
								</div>
					...
					<div class="row">
						...
						<div class="col-md-2">
							<button class="btn btn-default" name="btnChangeChkbox"
								type="button" onclick="changeCheckboxState()">Select All</button>
						</div>
						<div class="col-md-8">
							<button class="btn btn-default" name="btnSelectFleetTruckLinks"
								type="button" onclick="ajaxResetFleetCheckboxes()">Select Fleets
								where Truck is Active</button>
						</div>
					</div>
					<!-- End -->
					...
					<div class="row">
						<div class="col-md-6">
							<button class="btn btn-lg btn-primary btn-block"
								id="btnAddTruckLink" name="addTruckLink"
								onclick="ajaxAddTruckLink()" type="button">Add</button>
						</div>

						<div class="col-md-6">
							<button class="btn btn-lg btn-primary btn-block"
								id="btnCommitTruckLinks" name="commitTruckLinks"
								onclick="commitTransactions()" type="button">Commit</button>
						</div>
					</div>
				</form>
	...
	<script src="../assets/js/dtp/jquery.datetimepicker.js"></script>
	<script src="../assets/js/src/ftl_dtp.js"></script>
</body>
</html>
