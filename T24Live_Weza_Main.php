...
class T24Live_Weza_Main extends PHPUnit_Framework_TestCase {
	...
	public function testFunctionTemplate() {
		...
		$_csvfile = $this->readCSVFile("/home/clinton/Documents/MAX Live/Projects/Offline Capture WEZA/Weza Spreadsheets/Fixed/20140710.csv");
		if ($_csvfile != FALSE) {
			print_r($_csvfile);
		}
		exit;
	 ...
	 * @param string: $_file
	 */
	private function readCSVFile($_file) {
		if (($_handle = fopen($_file, "r")) !== FALSE) {
			$_data = (fgetcsv($_handle,0,","));
