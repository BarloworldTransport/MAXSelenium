...
class AutomationLibrary
{
    ...
    protected $pdoobj = false;

    protected $_curlMAX = false;
    ...
    public function dmInit()
    {
        if ($this->_dm_mode && is_string($this->_dm_mode)) {
            ...
            switch (strtolower($this->_dm_mode)) {
                case 'mysql':
                    {
                        break;
                    }
    ...
    /**
     * AutomationLibrary::initCurl()
     * Make an instance of the MAX_API_Get cURL object to make call cURL calls
     * to fetch MAX data
     *
     * @return bool
     */
    private function initCurl()
    {
        ...
        $this->_curlMAX = new MAX_API_Get(strtolower($this->_mode));
    }
